...
from foss4g2011_example3_starterdialog import foss4g2011_example3_starterDialog
#import pdb

#pyqtRemoveInputHook()
#pdb.set_trace()

class foss4g2011_example3_starter(QObject):
    ...
    def initGui(self):
        ...
        self.action = QAction(QIcon(":/plugins/foss4g2011_example3_starter/icon.png"), \
            "Example #3 Starter for FOSS4G 2011 Workshop", self.iface.mainWindow())
        # connect the action to the run method
        QObject.connect(self.action, SIGNAL("triggered()"), self.run)

        # Add toolbar button and menu item
        self.iface.addToolBarIcon(self.action)
        self.iface.addPluginToMenu("&Example #3 Starter for FOSS4G 2011 Workshop", self.action)

    def unload(self):
        # Remove the plugin menu item and icon
        self.iface.removePluginMenu("&Example #3 Starter for FOSS4G 2011 Workshop",self.action)
    ...
    def run(self):
        ...
        self.dlg = foss4g2011_example3_starterDialog(self.iface)
        # show the dialog
        self.dlg.show()
